...
class IRC2(TokenStandard, IconScoreBase):
    ...
    def transferFrom(self, sender: Address, recepient: Address, amount: int) -> bool:
        ...
        self._approve(
            sender,
            self.msg.sender,
            SafeMath.sub(self._allowances[sender][self.msg.sender], amount),
        )
        return True
    ...
    def increaseAllowance(self, spender: Address, value: int) -> bool:
        ...
        self._approve(
            self.msg.sender,
            spender,
            SafeMath.add(self._allowances[self.msg.sender][spender], value),
        )
        return True
    ...
    def decreaseAllowance(self, spender: Address, value: int) -> bool:
        ...
        self._approve(
            self.msg.sender,
            spender,
            SafeMath.sub(self._allowances[self.msg.sender][spender], value),
        )
        return True

    def _transfer(
        self, _from: Address, _to: Address, _value: int, _data: bytes = None
    ) -> None:
        """
